...
export const DocumentsDeleteDialog = (props: IDocumentsDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="investApplication3App.documents.delete.question">
        <Translate contentKey="investApplication3App.documents.delete.question" interpolate={{ id: documentsEntity.id }}>
